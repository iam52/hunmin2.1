...
public enum ErrorCode {
    ...
    MEMBER_INVALID_INPUT("회원 정보가 올바르지 않습니다.", HttpStatus.UNPROCESSABLE_ENTITY), // 422
    ...
    BOARD_INVALID_INPUT("게시글 정보가 올바르지 않습니다.", HttpStatus.UNPROCESSABLE_ENTITY), // 422
    ...
    COMMENT_INVALID_INPUT("댓글 정보가 올바르지 않습니다.", HttpStatus.UNPROCESSABLE_ENTITY), // 422
    ...
    BOOKMARK_INVALID_INPUT("북마크 정보가 올바르지 않습니다.", HttpStatus.UNPROCESSABLE_ENTITY), // 422
    ...
    CHAT_MESSAGE_INVALID_INPUT("메시지 정보가 올바르지 않습니다.", HttpStatus.UNPROCESSABLE_ENTITY), // 422
    ...
    CHAT_ROOM_INVALID_INPUT("채팅방 정보가 올바르지 않습니다.", HttpStatus.UNPROCESSABLE_ENTITY), // 422
    ...
    FOLLOW_INVALID_INPUT("팔로우 정보가 올바르지 않습니다.", HttpStatus.UNPROCESSABLE_ENTITY), // 422
    ...
    LIKE_INVALID_INPUT("좋아요 정보가 올바르지 않습니다.", HttpStatus.UNPROCESSABLE_ENTITY), // 422
    ...
    NOTICE_INVALID_INPUT("공지사항 정보가 올바르지 않습니다.", HttpStatus.UNPROCESSABLE_ENTITY), // 422
    ...
    NOTIFICATION_INVALID_INPUT("알림 정보가 올바르지 않습니다.", HttpStatus.UNPROCESSABLE_ENTITY), // 422
    ...
    WORD_INVALID_INPUT("단어 정보가 올바르지 않습니다.", HttpStatus.UNPROCESSABLE_ENTITY); // 422
