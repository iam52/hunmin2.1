package com.hunmin.domain.chatmessage.controller;
...
import com.hunmin.domain.chatmessage.service.ChatMessageService;
...
public class ChatMessageController {
    ...
    public MemberRequest getUserInfo(@AuthenticationPrincipal String email) {
